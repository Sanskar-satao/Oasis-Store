...
const apps = [
    { name: "Oasis Maps", icon: "Oasis-Store/Assets/icons/Omaps.webp", desc: "Find Your Destination And Location", link: "", category: "" },
    { name: "Quest AI", icon: "Oasis-Store/Assets/icons/QAI.png", desc: "Build For Students,Search Anything", link: "https://sanskar-satao.github.io/Quest-AI/", category: "Developer" },
    { name: "Oasis Browser", icon: "Oasis-Store/Assets/icons/OB.jpeg", desc: "Search For Anything, Anywhere", link: "https://sanskar-satao.github.io/Oasis-Browser/", category: "Browser" },
    { name: "Oasis Maths", icon: "Oasis-Store/Assets/icons/OMM.png", desc: "Solve Maths Problem In a Second", link: "", category: "Developer" },
    { name: "Google Chrome", icon: "Oasis-Store/Assets/icons/Chrome.webp", desc: "Fast, secure browser by Google.", link: "https://www.google.com/chrome/", category: "Browser" },
    { name: "Visual Studio Code", icon: "Oasis-Store/Assets/icons/vscode.jpg", desc: "Lightweight but powerful source code editor.", link: "https://code.visualstudio.com/", category: "Developer" },
    { name: "Spotify", icon: "Oasis-Store/Assets/icons/spotify.png", desc: "Millions of songs and podcasts.", link: "https://www.spotify.com/", category: "Entertainment" },
    { name: "Discord", icon: "Oasis-Store/Assets/icons/discord.webp", desc: "Communicate with communities and friends.", link: "https://discord.com/", category: "Social" },
    { name: "Steam", icon: "Oasis-Store/Assets/icons/Steam.png", desc: "PC gaming platform.", link: "https://store.steampowered.com/", category: "Entertainment" },
    { name: "Notion", icon: "Oasis-Store/Assets/icons/Notion.png", desc: "All-in-one workspace.", link: "https://www.notion.so/", category: "Productivity" },
    { name: "Zoom", icon: "Oasis-Store/Assets/icons/zoom.png", desc: "Video conferencing for work.", link: "https://zoom.us/", category: "Social" },
    { name: "Telegram", icon: "Oasis-Store/Assets/icons/Telegram.png", desc: "Fast and secure messaging.", link: "https://telegram.org/", category: "Social" },
    { name: "Brave", icon: "Oasis-Store/Assets/icons/brave.png", desc: "Privacy-first browser.", link: "https://brave.com/", category: "Browser" },
    { name: "Opera GX", icon: "Oasis-Store/Assets/icons/opera.png", desc: "Gaming browser with resource controls.", link: "https://www.opera.com/gx", category: "Browser" },
    { name: "GitHub Desktop", icon: "Oasis-Store/Assets/icons/github.png", desc: "Git GUI client for GitHub.", link: "https://desktop.github.com/", category: "Developer" },
    { name: "Microsoft Edge", icon: "Oasis-Store/Assets/icons/Edge.jpeg", desc: "Microsoft's modern browser.", link: "https://www.microsoft.com/edge", category: "Browser" },
    { name: "Snapchat", icon: "Oasis-Store/Assets/icons/Snapchat.jpg", desc: "A Fast Messenger App.", link: "https://www.snapchat.com/", category: "Social" },
    { name: "Tlauncher", icon: "Oasis-Store/Assets/icons/Tlauncher.webp", desc: "A Minecraft Launcher", link: "https://tlauncher.org/", category: "Entertainment" },
    { name: "Instagram", icon: "Oasis-Store/Assets/icons/Instagram.svg", desc: "A Reels Special App", link: "https://www.instagram.com/", category: "Social" },
    { name: "Arduino IDE", icon: "Oasis-Store/Assets/icons/Arduino.png", desc: "Code A Robot With IDE", link: "https://www.arduino.cc/en/software", category: "Developer" },
    { name: "Perplexity", icon: "Oasis-Store/Assets/icons/perplexity.png", desc: "Create, Build, Ask Perplexity", link: "https://www.perplexity.ai/", category: "Developer" },
    { name: "Microsoft Teams", icon: "Oasis-Store/Assets/icons/Teams.jpeg", desc: "Connect from Anywhere", link: "https://www.microsoft.com/en-in/microsoft-teams/log-in", category: "Social" },
    { name: "Canva", icon: "Oasis-Store/Assets/icons/Canva.jpeg", desc: "Create Using Cool Tampletes", link: "https://www.canva.com/en_in/", category: "Productivity" },
    { name: "Linkedin", icon: "Oasis-Store/Assets/icons/Linkdin.png", desc: "Find Jobs From anywhere", link: "https://www.linkedin.com/", category: "Social" },
    { name: "Microsoft Copilot", icon: "Oasis-Store/Assets/icons/Copilot.jpeg", desc: " Your AI companion", link: "https://copilot.microsoft.com/", category: "Developer" },
    { name: "Adobe Express", icon: "Oasis-Store/Assets/icons/AX.png", desc: "Free Design, Photo & Video Editing Tool", link: "https://www.adobe.com/in/express/", category: "Productivity" },
    { name: "X-Twitter", icon: "Oasis-Store/Assets/icons/X.png", desc: "breaking news and entertainment to sports and politics", link: "https://x.com/", category: "Social" },
    { name: "Meta AI", icon: "Oasis-Store/Assets/icons/Meta.png", desc: "Meta AI assistant to get things done, create AI-generated images for free", link: "https://www.meta.ai/", category: "Developer" },
    { name: "", icon: "Oasis-Store/Assets/icons/", desc: "", link: "", category: "" },
    { name: "", icon: "Oasis-Store/Assets/icons/", desc: "", link: "", category: "" },
    { name: "", icon: "Oasis-Store/Assets/icons/", desc: "", link: "", category: "" },
    { name: "", icon: "Oasis-Store/Assets/icons/", desc: "", link: "", category: "" },
    { name: "", icon: "Oasis-Store/Assets/icons/", desc: "", link: "", category: "" },
